...
if __name__ == '__main__':
    ...
    parameters = {
        ...
        "layers": [1, 2, 3],                  # Test different bundle sizes (layers)
        "repetition": range(2),                 # Repeat each condition 3 times for statistics
        ...
        "frequency": [100000],                   # Output frequency for reporters
    ...
    sjob = openactin.SlurmJobArray("Simulations_scratch/Bundles/061825/Benchmark", parameters, test_parameters)
