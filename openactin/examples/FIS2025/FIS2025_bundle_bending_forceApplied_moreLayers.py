...
if __name__ == '__main__':
    ...
    parameters = {
        ...
        "actinLen": [100, 200, 300],            # Shorter filament lengths
        "layers": [2, 3, 4, 5, 6, 7, 8, 9, 10],             # Test different bundle sizes (layers, now up to 10)
    ...
    sjob = openactin.SlurmJobArray("Simulations_scratch/Bundles/Bending_070125/MoreLayers", parameters, test_parameters)
